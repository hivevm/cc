...
1. The output language is the enum [`org.hivevm.cc.Language`](../../src/main/java/org/hivevm/waggle/api/Language.java)
   (`JAVA`, `CPP`, `RUST`), chosen via the `CODE_GENERATOR` option (default `java`).
2. Back ends implement the
   [`org.hivevm.cc.generator.Generator`](../../src/main/java/org/hivevm/waggle/codegen/Generator.java)
