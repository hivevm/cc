 ...
 * {@code […]} — decides between its alternatives. {@link ParserPlanner} makes these decisions once;
 ...
 */
public record LookaheadPlan(List<Step> steps, int defaultMask) {
     ...
     */
    public record Step(Kind kind, Lookahead la, int[] tokens, int mask) {
    }
