...
/**
 * Builds the NFA structures for all lexer states.
 */
class NfaBuilder {
     ...
     */
    static void generateNfaStartStates(NfaStateData data, NfaState initialState) {
     ...
     */
    static void calcNfaStartStatesCode(NfaStateData data,
