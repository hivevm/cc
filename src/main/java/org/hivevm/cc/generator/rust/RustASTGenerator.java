...
class RustASTGenerator extends TreeGenerator {
    ...
    private void generateTreeState(TreeOptions context) {
        TemplateProvider provider = RustTemplate.TREE_STATE;
    ...
    private void generateTreeConstants(TreeOptions context) {
        ...
        TemplateProvider provider = RustTemplate.TREE_CONSTANTS;
    ...
    private void generateVisitors(TreeOptions context) {
        ...
        String returnValue = RustASTGenerator.returnValue(context.getVisitorReturnType(), argumentType);
        ...
        TemplateProvider provider = RustTemplate.VISITOR;
        provider.render(options, context.getParserName());

        provider = RustTemplate.DEFAULT_VISITOR;
        provider.render(options, context.getParserName());
    }

    private void generateNode(TreeOptions context) {
        TemplateProvider provider = RustTemplate.NODE;
    ...
    private void generateTreeNodes(TreeOptions context) {
        ...
        for (String nodeType : nodesToGenerate()) {
            ...
            TemplateProvider provider = RustTemplate.MULTI_NODE;
    ...
    private void findThrown(NodeScope ns, Hashtable<String, String> thrown_set,
        ...
        if (expansion_unit instanceof ASTBNFNonTerminal) {
            ...
            ASTProduction prod = expansion_unit.jjtParser().getProduction(nt);
            if (prod != null) {
