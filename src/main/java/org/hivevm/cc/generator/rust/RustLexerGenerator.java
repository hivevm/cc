...
class RustLexerGenerator extends LexerGenerator {
    ...
    public final void generate(LexerData data) {
        ...
        options.set("LITERAL_IMAGES", () -> RustLexerGenerator.getStrLiteralImages(data));
        ...
        TemplateProvider provider = RustTemplate.LEXER;
    ...
    protected final void generateConstants(LexerData data) {
        ...
        TemplateProvider.render(RustTemplate.PARSER_CONSTANTS, options, data.getParserName());
    }
