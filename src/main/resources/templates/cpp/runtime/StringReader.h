...
//
// Derived from JavaCC 7.0.12: src/main/resources/templates/cpp/CharStream.h.template, src/main/resources/templates/CharStream.template
...
public:
	...
	StringReader(const JJString & str);
...
private:
	...
	void init();
	void updateLineColumn(uint32_t c);
};
