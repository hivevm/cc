...
//
// Derived from JavaCC 7.0.12: src/main/resources/templates/cpp/TokenMgrError.h.template, org/javacc/jjtree/TokenMgrException.java
...
#ifndef WAGGLE_TOKEN_MANAGER_ERROR
#define WAGGLE_TOKEN_MANAGER_ERROR
