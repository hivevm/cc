...
//
// Derived from JavaCC 7.0.12: src/main/resources/templates/cpp/ErrorHandler.h.template
...
#ifndef WAGGLE_PARSER_ERROR_HANDLER
#define WAGGLE_PARSER_ERROR_HANDLER
