...
class TokenException extends RuntimeException {
     ...
     * Full Constructor.
     */
    public TokenException(boolean EOFSeen, int lexState, int errorLine, int errorColumn,
        String errorAfter,
        int curChar, int reason) {
        this(TokenException.LexicalErr(EOFSeen, lexState, errorLine, errorColumn, errorAfter,
            curChar), reason);
    }
